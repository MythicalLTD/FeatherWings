...
func (e *Environment) Create() error {
	...
	var serverNetConfig = cfg.Docker.Network
	if serverNetConfig.Driver == "macvlan" { // Generate networking config for macvlan driver
		var defaultMapping = a.DefaultMapping
	...
	// Pass the networking configuration or nil if none required
