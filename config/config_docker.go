...
type dockerNetworkInterfaces struct {
	V4 struct {
		Subnet  string `default:"172.19.0.0/16"`
		Gateway string `default:"172.19.0.1"`
	}
	V6 struct {
...
type DockerNetworkConfiguration struct {
	...
	// defined.
	Name       string                  `default:"featherpanel_nw"`
...
type DockerConfiguration struct {
	...
	// if the value is "host", then the featherpanel containers are started with user namespace
	// remapping disabled
